...
const cartoonApi = axios.create({
  baseURL: "http://ec2-3-133-137-52.us-east-2.compute.amazonaws.com",
  // refreshToken을 Cookie로 주고받기 위해..
});
...
export const imageApi = {
  imageTransition: (images, image_length) => {
    ...
    return cartoonApi({
      method: "post",
      url:
        "http://ec2-3-133-137-52.us-east-2.compute.amazonaws.com/cartoon/transition",
      data: form,
